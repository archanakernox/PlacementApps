  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="pAppsNavbar">
	   <ul class="nav navbar-nav">
	      ...
	      <li  class="active"><a href="<c:url value = "/recruiterregister"/>">Recruiter</a></li>
				...
				<div class="panel-body">
				   	<form action="">
						...
						<div class="form-group">
						    ...
						    <input type="textbox" class="form-control" id="dob">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
						    <label for="alternateno">Alternate Mobile Number:</label>
						    <input type="textbox" class="form-control" id="alternateno">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
						    <label for="file">Attach file/Resume:</label>
